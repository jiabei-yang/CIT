...
res.rhcSimSubFtr.ipw.AFrst5.YLnrFrst5 <- 
  foreach(i = start:end,
          .combine = "rbind") %dopar% {
            ...
            final.tree.eff <- EstIpw.CvMethod1(data.used         = rhc.eff.train, 
            ...
            final.tree.noeff <- EstIpw.CvMethod1(data.used         = rhc.noeff.train, 
...
save(res.rhcSimSubFtr.ipw.AFrst5.YLnrFrst5, file = paste0("../Data/AppendixD4/RhcSimSubFtrIpwAFrst5YLnrFrst5.RData"))
