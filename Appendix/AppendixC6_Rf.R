...
performance.drOut <- 
  foreach(i = start:end,
          .combine  = "rbind") %dopar% {
            ...
            performance.hetero.drOut <- c(eval.final.estdr.adjNoisGlmOut.propscNoisGlmOut.cv1,
                                          eval.final.estdr.adjFGlmOut.propscFGlmOut.cv1,
                                          eval.final.estdr.adjNoisGlmOut.propscNoisGlmOut.cv2,
                                          eval.final.estdr.adjFGlmOut.propscFGlmOut.cv2)
            ...
            seq.created.estdr.adjNoisGlmOut.propscNoisGlmOut.cv2 <- create.sequence(data.used         = data.used.full.cont.cont,
                                                                                    ...
                                                                                    propsc.mthd       = "RF",
                                                                                    # propsc.form.true  = "A ~ exp(X1) + exp(X2) + exp(X3) + exp(X4) + exp(X5) + exp(X6)",
                                                                                    propsc.form.true  = NULL,                                                                                    adj.mod.loc       = "out", 
                                                                                    adj.mthd          = "RF", 
                                                                                    adj.form.true     = NULL, 
                                                                                    num.truc.obs      = 30,
                                                                                    min.node          = 20)
            ...
            performance.homo.drOut <- c(eval.final.estdr.adjNoisGlmOut.propscNoisGlmOut.cv1,
                                        eval.final.estdr.adjFGlmOut.propscFGlmOut.cv1,
                                        eval.final.estdr.adjNoisGlmOut.propscNoisGlmOut.cv2,
                                        eval.final.estdr.adjFGlmOut.propscFGlmOut.cv2)
...
save(performance.drOut, file = paste0("../Data/AppendixC6/Rf.RData"))
