...
performance.ipwInnd <- 
  foreach(i = start:end,
          .combine  = "rbind") %dopar% {
            ...
            #####################################################################################################################
            ######################### 2. ipw: GLM Model, inside node, Noisy propensity score model, Cv2 #########################
            #####################################################################################################################
            t0 <- Sys.time()
            ...
            performance.hetero.ipwInnd <- c(eval.final.estipw.glm.propscinnd.true.cv2,
            ...
            performance.homo.ipwInnd <- c(eval.final.estipw.glm.propscinnd.true.cv2,
                                          eval.final.estipw.glm.propscinnd.nois.cv2,
                                          eval.final.estipw.glm.propscinnd.mis.cv2)
...
save(performance.ipwInnd, file = "../Data/AppendixC4/Cv2Ipw.RData")
