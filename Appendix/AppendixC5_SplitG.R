...
performance.gInsplt <- 
  foreach(i = start:end,
          .combine  = "rbind") %dopar% {
            ...
            eval.final.estg.glm.modinsplt.true.cv1                <- unlist(eval.final.estg.glm.modinsplt.true.cv1)
            names(eval.final.estg.glm.modinsplt.true.cv1)         <- paste0("hetero.g.glm.modinsplt.true.cv1.", names(eval.final.estg.glm.modinsplt.true.cv1))
            print("1.cv1.T")
            ...
            eval.final.estg.glm.modinsplt.nois.cv1                <- unlist(eval.final.estg.glm.modinsplt.nois.cv1)
            names(eval.final.estg.glm.modinsplt.nois.cv1)         <- paste0("hetero.g.glm.modinsplt.nois.cv1.", names(eval.final.estg.glm.modinsplt.nois.cv1))
            print("2.cv1.nois")
            ...
            eval.final.estg.glm.modinsplt.mis.cv1                <- unlist(eval.final.estg.glm.modinsplt.mis.cv1)
            names(eval.final.estg.glm.modinsplt.mis.cv1)         <- paste0("hetero.g.glm.modinsplt.mis.cv1.", names(eval.final.estg.glm.modinsplt.mis.cv1))
            print("3.cv1.mis")
            ...
            eval.final.estg.glm.modinsplt.true.cv2                <- unlist(eval.final.estg.glm.modinsplt.true.cv2)
            names(eval.final.estg.glm.modinsplt.true.cv2)         <- paste0("hetero.g.glm.modinsplt.true.cv2.", names(eval.final.estg.glm.modinsplt.true.cv2))
            print("4.cv2.T")
            ...
            eval.final.estg.glm.modinsplt.nois.cv2                <- unlist(eval.final.estg.glm.modinsplt.nois.cv2)
            names(eval.final.estg.glm.modinsplt.nois.cv2)         <- paste0("hetero.g.glm.modinsplt.nois.cv2.", names(eval.final.estg.glm.modinsplt.nois.cv2))
            print("5.cv2.nois")
            ...
            eval.final.estg.glm.modinsplt.mis.cv2                <- unlist(eval.final.estg.glm.modinsplt.mis.cv2)
            names(eval.final.estg.glm.modinsplt.mis.cv2)         <- paste0("hetero.g.glm.modinsplt.mis.cv2.", names(eval.final.estg.glm.modinsplt.mis.cv2))
            print("6.cv2.mis")
            
            performance.hetero.g <- c(eval.final.estg.glm.modinsplt.true.cv1,
                                      eval.final.estg.glm.modinsplt.nois.cv1,
                                      eval.final.estg.glm.modinsplt.mis.cv1,
                                      eval.final.estg.glm.modinsplt.true.cv2,
                                      eval.final.estg.glm.modinsplt.nois.cv2,
                                      eval.final.estg.glm.modinsplt.mis.cv2)
            ...
            eval.final.estg.glm.modinsplt.true.cv1$t <- as.numeric(difftime(t1, t0, units = "secs"))
            eval.final.estg.glm.modinsplt.true.cv1                <- unlist(eval.final.estg.glm.modinsplt.true.cv1)
            names(eval.final.estg.glm.modinsplt.true.cv1)         <- paste0("homo.g.glm.modinsplt.true.cv1.", names(eval.final.estg.glm.modinsplt.true.cv1))
            print("7.cv1.T")
            ...
            eval.final.estg.glm.modinsplt.nois.cv1$t <- as.numeric(difftime(t1, t0, units = "secs"))
            eval.final.estg.glm.modinsplt.nois.cv1                <- unlist(eval.final.estg.glm.modinsplt.nois.cv1)
            names(eval.final.estg.glm.modinsplt.nois.cv1)         <- paste0("homo.g.glm.modinsplt.nois.cv1.", names(eval.final.estg.glm.modinsplt.nois.cv1))
            print("8.cv1.nois")
            ...
            eval.final.estg.glm.modinsplt.mis.cv1$t <- as.numeric(difftime(t1, t0, units = "secs"))
            eval.final.estg.glm.modinsplt.mis.cv1                <- unlist(eval.final.estg.glm.modinsplt.mis.cv1)
            names(eval.final.estg.glm.modinsplt.mis.cv1)         <- paste0("homo.g.glm.modinsplt.mis.cv1.", names(eval.final.estg.glm.modinsplt.mis.cv1))
            print("9.cv1.mis")
            ...
            eval.final.estg.glm.modinsplt.true.cv2$t <- as.numeric(difftime(t1, t0, units = "secs"))
            eval.final.estg.glm.modinsplt.true.cv2                <- unlist(eval.final.estg.glm.modinsplt.true.cv2)
            names(eval.final.estg.glm.modinsplt.true.cv2)         <- paste0("homo.g.glm.modinsplt.true.cv2.", names(eval.final.estg.glm.modinsplt.true.cv2))
            print("10.cv2.T")
            ...
            eval.final.estg.glm.modinsplt.nois.cv2$t <- as.numeric(difftime(t1, t0, units = "secs"))
            eval.final.estg.glm.modinsplt.nois.cv2                <- unlist(eval.final.estg.glm.modinsplt.nois.cv2)
            names(eval.final.estg.glm.modinsplt.nois.cv2)         <- paste0("homo.g.glm.modinsplt.nois.cv2.", names(eval.final.estg.glm.modinsplt.nois.cv2))
            print("11.cv2.nois")
            ...
            eval.final.estg.glm.modinsplt.mis.cv2$t <- as.numeric(difftime(t1, t0, units = "secs"))
            eval.final.estg.glm.modinsplt.mis.cv2                <- unlist(eval.final.estg.glm.modinsplt.mis.cv2)
            names(eval.final.estg.glm.modinsplt.mis.cv2)         <- paste0("homo.g.glm.modinsplt.mis.cv2.", names(eval.final.estg.glm.modinsplt.mis.cv2))
            print("12.cv2.mis")
            
            performance.homo.g <- c(eval.final.estg.glm.modinsplt.true.cv1,
                                    eval.final.estg.glm.modinsplt.nois.cv1,
                                    eval.final.estg.glm.modinsplt.mis.cv1,
                                    eval.final.estg.glm.modinsplt.true.cv2,
                                    eval.final.estg.glm.modinsplt.nois.cv2,
...
save(performance.gInsplt, file = paste0("../Data/AppendixC5/SplitG.RData"))
