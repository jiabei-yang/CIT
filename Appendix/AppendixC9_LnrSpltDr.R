  ...
  foreach(i = start:end,
          .combine  = "rbind") %dopar% {
            ...
            seq.created.estdr.adjTGlmInnd.propscTGlmInnd.cv1 <- create.sequence(data.used         = data.used.cont.cont,
                                                                                ...
                                                                                adj.mod.loc       = "node", 
                                                                                adj.mthd          = "GLM", 
                                                                                adj.form.true     = "Y ~ A + I(X1 < 0) + exp(X2) + I(X5^3) + A:X4 + A:I(X6^2)", 
                                                                                num.truc.obs      = 30,
                                                                                min.node          = 20)
            ...
            eval.final.estdr.adjTGlmInnd.propscTGlmInnd.cv1$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjTGlmInnd.propscTGlmInnd.cv1[[1]], 
                                                                                                              corr.split = c("X4", "X6"), 
                                                                                                              num.nodes  = 7)  
            eval.final.estdr.adjTGlmInnd.propscTGlmInnd.cv1$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjTGlmInnd.propscTGlmInnd.cv1[[1]], 
                                                                                                              corr.split = c("X4", "X6"), 
                                                                                                              num.nodes  = 15)  
            ...
            eval.final.estdr.adjTGlmInnd.propscNoisGlmInnd.cv1$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjTGlmInnd.propscNoisGlmInnd.cv1[[1]], 
                                                                                                                 corr.split = c("X4", "X6"), 
                                                                                                                 num.nodes  = 7)  
            eval.final.estdr.adjTGlmInnd.propscNoisGlmInnd.cv1$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjTGlmInnd.propscNoisGlmInnd.cv1[[1]], 
                                                                                                                 corr.split = c("X4", "X6"), 
                                                                                                                 num.nodes  = 15)  
            ...
            eval.final.estdr.adjNoisGlmInnd.propscTGlmInnd.cv1$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjNoisGlmInnd.propscTGlmInnd.cv1[[1]], 
                                                                                                                 corr.split = c("X4", "X6"), 
                                                                                                                 num.nodes  = 7)  
            eval.final.estdr.adjNoisGlmInnd.propscTGlmInnd.cv1$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjNoisGlmInnd.propscTGlmInnd.cv1[[1]], 
                                                                                                                 corr.split = c("X4", "X6"), 
                                                                                                                 num.nodes  = 15)  
            ...
            eval.final.estdr.adjNoisGlmInnd.propscNoisGlmInnd.cv1$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjNoisGlmInnd.propscNoisGlmInnd.cv1[[1]], 
                                                                                                                    corr.split = c("X4", "X6"), 
                                                                                                                    num.nodes  = 7)  
            eval.final.estdr.adjNoisGlmInnd.propscNoisGlmInnd.cv1$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjNoisGlmInnd.propscNoisGlmInnd.cv1[[1]], 
                                                                                                                    corr.split = c("X4", "X6"), 
                                                                                                                    num.nodes  = 15)  
            ...
            eval.final.estdr.adjFGlmInnd.propscFGlmInnd.cv1$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjFGlmInnd.propscFGlmInnd.cv1[[1]], 
                                                                                                              corr.split = c("X4", "X6"), 
                                                                                                              num.nodes  = 7)  
            eval.final.estdr.adjFGlmInnd.propscFGlmInnd.cv1$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjFGlmInnd.propscFGlmInnd.cv1[[1]], 
                                                                                                              corr.split = c("X4", "X6"), 
                                                                                                              num.nodes  = 15)  
            ...
            eval.final.estdr.adjTGlmInnd.propscTGlmInnd.cv2$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjTGlmInnd.propscTGlmInnd.cv2[[1]], 
                                                                                                              corr.split = c("X4", "X6"), 
                                                                                                              num.nodes  = 7)  
            eval.final.estdr.adjTGlmInnd.propscTGlmInnd.cv2$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjTGlmInnd.propscTGlmInnd.cv2[[1]], 
                                                                                                              corr.split = c("X4", "X6"), 
                                                                                                              num.nodes  = 15)  
            ...
            eval.final.estdr.adjTGlmInnd.propscNoisGlmInnd.cv2$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjTGlmInnd.propscNoisGlmInnd.cv2[[1]], 
                                                                                                                 corr.split = c("X4", "X6"), 
                                                                                                                 num.nodes  = 7)  
            eval.final.estdr.adjTGlmInnd.propscNoisGlmInnd.cv2$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjTGlmInnd.propscNoisGlmInnd.cv2[[1]], 
                                                                                                                 corr.split = c("X4", "X6"), 
                                                                                                                 num.nodes  = 15)  
            ...
            eval.final.estdr.adjNoisGlmInnd.propscTGlmInnd.cv2$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjNoisGlmInnd.propscTGlmInnd.cv2[[1]], 
                                                                                                                 corr.split = c("X4", "X6"), 
                                                                                                                 num.nodes  = 7)  
            eval.final.estdr.adjNoisGlmInnd.propscTGlmInnd.cv2$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjNoisGlmInnd.propscTGlmInnd.cv2[[1]], 
                                                                                                                 corr.split = c("X4", "X6"), 
                                                                                                                 num.nodes  = 15)  
            ...
            eval.final.estdr.adjNoisGlmInnd.propscNoisGlmInnd.cv2$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjNoisGlmInnd.propscNoisGlmInnd.cv2[[1]], 
                                                                                                                    corr.split = c("X4", "X6"), 
                                                                                                                    num.nodes  = 7)  
            eval.final.estdr.adjNoisGlmInnd.propscNoisGlmInnd.cv2$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjNoisGlmInnd.propscNoisGlmInnd.cv2[[1]], 
                                                                                                                    corr.split = c("X4", "X6"), 
                                                                                                                    num.nodes  = 15)  
            ...
            eval.final.estdr.adjFGlmInnd.propscFGlmInnd.cv2$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjFGlmInnd.propscFGlmInnd.cv2[[1]], 
                                                                                                              corr.split = c("X4", "X6"), 
                                                                                                              num.nodes  = 7)  
            eval.final.estdr.adjFGlmInnd.propscFGlmInnd.cv2$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estdr.adjFGlmInnd.propscFGlmInnd.cv2[[1]], 
                                                                                                              corr.split = c("X4", "X6"), 
                                                                                                              num.nodes  = 15)  
            ...
            seq.created.estdr.adjTGlmInnd.propscTGlmInnd.cv1 <- create.sequence(data.used         = data.used.cont.cont,
                                                                                ...
                                                                                adj.mod.loc       = "node", 
                                                                                adj.mthd          = "GLM", 
                                                                                adj.form.true     = "Y ~ A + I(X1 < 0) + exp(X2) + X4 + I(X5^3) + I(X6^2)", 
                                                                                num.truc.obs      = 30,
                                                                                min.node          = 20)
...
save(performance.drInnd, file = paste0("../Data/AppendixC9/LnrSpltDr.RData"))
