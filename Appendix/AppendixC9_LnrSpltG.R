...
performance.gInnd <- 
  foreach(i = start:end,
          .combine  = "rbind") %dopar% {
            ...
            eval.final.estg.glm.modinnd.true.cv1$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.true.cv1[[1]], 
                                                                                                   corr.split = c("X4", "X6"), 
                                                                                                   num.nodes  = 7)  
            eval.final.estg.glm.modinnd.true.cv1$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.true.cv1[[1]], 
                                                                                                   corr.split = c("X4", "X6"), 
                                                                                                   num.nodes  = 15)  
            ...
            eval.final.estg.glm.modinnd.nois.cv1$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.nois.cv1[[1]], 
                                                                                                   corr.split = c("X4", "X6"), 
                                                                                                   num.nodes  = 7)  
            eval.final.estg.glm.modinnd.nois.cv1$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.nois.cv1[[1]], 
                                                                                                   corr.split = c("X4", "X6"), 
                                                                                                   num.nodes  = 15)  
            ...
            eval.final.estg.glm.modinnd.mis.cv1$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.mis.cv1[[1]], 
                                                                                                  corr.split = c("X4", "X6"), 
                                                                                                  num.nodes  = 7)  
            eval.final.estg.glm.modinnd.mis.cv1$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.mis.cv1[[1]], 
                                                                                                  corr.split = c("X4", "X6"), 
                                                                                                  num.nodes  = 15)  
            ...
            eval.final.estg.glm.modinnd.true.cv2$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.true.cv2[[1]], 
                                                                                                   corr.split = c("X4", "X6"), 
                                                                                                   num.nodes  = 7)  
            eval.final.estg.glm.modinnd.true.cv2$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.true.cv2[[1]], 
                                                                                                   corr.split = c("X4", "X6"), 
                                                                                                   num.nodes  = 15)  
            ...
            eval.final.estg.glm.modinnd.nois.cv2$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.nois.cv2[[1]], 
                                                                                                   corr.split = c("X4", "X6"), 
                                                                                                   num.nodes  = 7)  
            eval.final.estg.glm.modinnd.nois.cv2$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.nois.cv2[[1]], 
                                                                                                   corr.split = c("X4", "X6"), 
                                                                                                   num.nodes  = 15)  
            ...
            eval.final.estg.glm.modinnd.mis.cv2$p.corr.3lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.mis.cv2[[1]], 
                                                                                                  corr.split = c("X4", "X6"), 
                                                                                                  num.nodes  = 7)  
            eval.final.estg.glm.modinnd.mis.cv2$p.corr.4lvl.splts <- eval.lnrSplt.corr.frst.splts(tree       = final.tree.estg.glm.modinnd.mis.cv2[[1]], 
                                                                                                  corr.split = c("X4", "X6"), 
                                                                                                  num.nodes  = 15)  
...
save(performance.gInnd, file = paste0("../Data/AppendixC9/LnrSpltG.RData"))
