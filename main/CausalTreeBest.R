...
performance.ct <- foreach(i = start:end,
                          .combine  = "rbind") %dopar% {
                            ...
                            performance.hetero.ct <- c(eval.ct.propsc.true.nohonest, eval.ct.propsc.true.honest,
                                                       eval.ct.propsc.nois.nohonest, eval.ct.propsc.nois.honest,
                                                       eval.ct.propsc.mis.nohonest, eval.ct.propsc.mis.honest)
                            ...
                            performance.homo.ct <- c(eval.ct.propsc.true.nohonest, eval.ct.propsc.true.honest,
                                                     eval.ct.propsc.nois.nohonest, eval.ct.propsc.nois.honest,
                                                     eval.ct.propsc.mis.nohonest, eval.ct.propsc.mis.honest)
...
save(performance.ct, file = paste0("../Data/main/CausalTreeBest.RData"))
